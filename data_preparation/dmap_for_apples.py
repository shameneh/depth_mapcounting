...
if __name__ == '__main__':
    phase_list = ['train_whole_videos','test_whole_videos']
    for phase in phase_list:
        if not os.path.exists('../../datasets/'+phase+'/densitymaps'):
            os.mkdir('../../datasets/'+phase+'/densitymaps')
        image_file_list = os.listdir('../../datasets/'+phase+'/images')
        for image_file in tqdm(image_file_list):
            image_path = '../../datasets/'+phase+'/images/' + image_file
